  ...
  <div class="container py-4">
    ...
    <form action="{{route('comics.update', $comic->id)}}" method="post">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="thumb" id="thumb" class="form-control @error('thumb') is-invalid @enderror" placeholder="Http://" aria-describedby="helpId" value="{{old('thumb', $comic->image)}}">
